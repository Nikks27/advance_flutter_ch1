import 'package:advance_flutter_ch1/Screens/QuotesData/Modal/Qoutes_Modal.dart';
...
class QoutesProvider extends ChangeNotifier
{


  void addData(int index)
  {
     qoutesdata=txtquote.text;
     qoutesdata=txtauthor.text;
     QoutesData.insert(0,{
       "quote": QoutesData,
       "author": authordata,
     },);
